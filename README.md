...
当前版本为 **1.0.10-slim**。如果希望在本地开发或参与项目，需要 Node.js 20.6+；相关配置可参考 [`.env.example`](./.env.example)。
...
- **被发现与被理解**：可配置 SEO 信息，也可以独立或同时接入 Google Analytics 4 与 Umami（Cloud/自托管），了解公开画廊的访问与交互情况。
