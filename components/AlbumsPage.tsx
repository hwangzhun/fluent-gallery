...
export function AlbumsPage() {
  ...
  const open = async (album: Album, button: HTMLButtonElement) => {
    analytics.selectContent('album', album.id, 'album');
    ...
    try {
      ...
      analytics.selectContent('photo', detail.photos[0].id, 'album', { album_id: album.id, content_position: 1 });
