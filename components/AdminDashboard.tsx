...
type Section = 'albums' | 'photos' | 'tags' | 'settings' | 'logs';
const APP_VERSION = import.meta.env.VITE_APP_VERSION || '0.0.0';
const sections: Array<{ id: Section; label: string; icon: typeof Image }> = [{ id: 'photos', label: '照片管理', icon: Image }, { id: 'albums', label: '画册管理', icon: Image }, { id: 'tags', label: '标签管理', icon: Tags }, { id: 'settings', label: '系统设置', icon: Settings }, { id: 'logs', label: '系统日志', icon: FileText }];
